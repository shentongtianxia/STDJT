...
function App() {
  ...
  const [query, setQuery] = useAppState("");        // committed search query
  const [searchValue, setSearchValue] = useAppState(""); // topbar input value
  const [doc, setDoc] = useAppState(null);          // app-level doc reader
